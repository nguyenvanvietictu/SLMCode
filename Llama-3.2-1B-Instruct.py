# chạy trên server không cần treo máy
# Câu lệnh: nohup /mnt/hdd2/vietnv/anaconda/anaconda3/envs/icta2025/bin/python cita2025/Phi-3.5-mini-instruct.py > cita2025/Phi-3.5-mini-instruct.log 2>&1 &
# Thay đổi khanh.py thành tên file python cần chạy
# Thay đổi khanh.log thành tên file log cần lưu thông tin (hoặc /dev/null nếu không cần lưu log)
